  ...
  _defaults: {
    ...
    jobs: [
      ...
      },
      {
        ...
        description: 'Amadeus is actively seeking talented and enthusiastic Junior Software Development Engineers to join their innovative team in Bangalore. This entry-level role is specifically designed for fresh graduates and recent alumni from the 2024, 2025, 2026, 2027, and 2028 batches, offering a unique opportunity to contribute to the development of cutting-edge travel technology solutions.',
        applications: [], postedAt: '2026-07-13', deadline: '2026-08-30', status: 'Active',
      ...
      {
        id: 'JOB_SCRAPE_003', company: 'Johnson Controls', companyLogo: 'J', role: 'Graduate Engineer Trainee - Full Stack Developer',
        type: 'Job', domain: 'Web Dev', location: 'Pune, Maharashtra', mode: 'Hybrid',
        stipend: 'Best in Industry', skills: ['JavaScript', 'React', 'Node.js', 'SQL', 'HTML/CSS'], experience: 'Fresher (2024-2028 batch)',
        description: 'Johnson Controls is inviting talented and ambitious freshers and recent graduates to join their team as a Graduate Engineer Trainee (GET) - Full Stack Developer in Pune. This hybrid role offers a remarkable opportunity for individuals from the 2024, 2025, 2026, 2027, and 2028 batches to kickstart their career with a global leader. You will design, develop, and maintain robust web applications.',
        applications: [], postedAt: '2026-07-13', deadline: '2026-08-25', status: 'Active',
        aboutCompany: 'Johnson Controls is a global leader in smart, healthy and sustainable buildings.',
        perks: ['Work-Life Balance', 'Learning Budget', 'Wellness Program', 'PPO Potential'],
        process: ['Aptitude & Technical Test', 'Tech Interview', 'HR Interview'],
        applyLink: 'https://www.offcampusjobsindia.com/jobs/johnson-controls-graduate-engineer-trainee-full-stack-developer-pune'
      },
      {
        id: 'JOB_SCRAPE_004', company: 'Deutsche Bank', companyLogo: 'D', role: 'TDI Apprentice',
        type: 'Job', domain: 'Data Science', location: 'Pune, Maharashtra', mode: 'On-site',
        stipend: 'Competitive Stipend', skills: ['Java', 'Python', 'SQL', 'Data Analytics', 'Excel'], experience: 'Fresher (2026-2027 batch)',
        description: 'Deutsche Bank is opening its doors for aspiring talent through the India TDI (Technology & Data Innovation) Apprentice Hiring program for the 2026 and 2027 batches. This off-campus opportunity in Pune is designed for freshers eager to kickstart their careers in a leading global financial institution. You will gain hands-on experience, learn from industry experts, and work on technology and data innovation.',
        applications: [], postedAt: '2026-07-13', deadline: '2026-09-10', status: 'Active',
        aboutCompany: 'Deutsche Bank is a leading global investment bank with a strong private client franchise.',
        perks: ['Structured Mentorship', 'Apprentice Certificate', 'Global Network', 'Meals Allowance'],
        process: ['Online Assessment', 'Technical Panel Interview', 'HR Review'],
        applyLink: 'https://www.offcampusjobsindia.com/jobs/deutsche-bank-tdi-apprentice-hiring-2026-2027-pune'
      },
      {
        id: 'JOB_SCRAPE_005', company: 'HealthEdge', companyLogo: 'H', role: 'Associate Technical Services Engineer',
        type: 'Job', domain: 'Cloud', location: 'Bangalore, Karnataka', mode: 'On-site',
        stipend: 'Best in Industry', skills: ['Technical Support', 'SQL', 'Linux', 'Troubleshooting', 'XML'], experience: 'Fresher / Entry level',
        description: 'HealthEdge is actively seeking an Associate Technical Services Engineer to join their team in Bangalore. This frontline product and technical support role involves troubleshooting customer issues, identifying effective solutions, and ensuring timely resolution within established SLA guidelines. Excellent communication skills and a passion for customer success are required.',
        applications: [], postedAt: '2026-07-13', deadline: '2026-08-15', status: 'Active',
        aboutCompany: 'HealthEdge provides modern, disruptive technology systems for healthcare payors.',
        perks: ['Flexible Offs', 'Learning Certifications', 'Comprehensive Health Plan'],
        process: ['Technical Screening', 'Case Discussion Interview', 'Managerial Round', 'HR'],
        applyLink: 'https://www.offcampusjobsindia.com/jobs/healthedge-associate-technical-services-engineer-offcampus-bangalore-2024'
      },
      {
        id: 'JOB_SCRAPE_006', company: 'Wipro Limited', companyLogo: 'W', role: 'Developer L1 (AI/ML, RPA)',
        type: 'Job', domain: 'AI/ML', location: 'Bengaluru, Karnataka', mode: 'Hybrid',
        stipend: 'Best in Industry', skills: ['AI/ML', 'Python', 'RPA', 'Automation', 'Machine Learning'], experience: 'Fresher (2024-2028 batch)',
        description: 'Wipro Limited is hiring for the DEVELOPER L1 role in Bengaluru. This is an excellent off-campus opportunity for freshers from the 2024, 2025, 2026, 2027, and 2028 batches to begin their career in the IT industry. You will contribute to cutting-edge AI, machine learning, and RPA automation projects.',
        applications: [], postedAt: '2026-07-13', deadline: '2026-09-05', status: 'Active',
        aboutCompany: 'Wipro is a leading technology services and consulting company.',
        perks: ['Great Work Environment', 'Automation Trainings', 'Performance Incentives'],
        process: ['Wipro Coding Assessment', 'Tech Round', 'HR Round'],
        applyLink: 'https://www.offcampusjobsindia.com/jobs/wipro-developer-l1-off-campus-jobs-bengaluru-freshers'
      },
      {
        id: 'JOB_SCRAPE_007', company: 'Larsen & Toubro', companyLogo: 'L', role: 'Software Engineer (Off-Campus)',
        type: 'Job', domain: 'Web Dev', location: 'Across India', mode: 'On-site',
        stipend: 'Best in Industry', skills: ['Java', 'C#', '.NET', 'SQL', 'Software Engineering'], experience: 'Fresher (2024-2028 batch)',
        description: 'Larsen & Toubro (L&T) is inviting bright and enthusiastic freshers for Software Engineer roles through their Off-Campus recruitment drive. This is an excellent opportunity for graduates from the 2024, 2025, 2026, 2027, and 2028 batches to join a leading Indian multinational conglomerate. You will develop innovative solutions and drive digital transformation.',
        applications: [], postedAt: '2026-07-13', deadline: '2026-08-20', status: 'Active',
        aboutCompany: 'L&T is an Indian multinational engaged in technology, engineering, construction, and manufacturing.',
        perks: ['Stability & Growth', 'Regular Increment Plans', 'Learning & Development'],
        process: ['Aptitude Test', 'Technical Test', 'Interviews'],
        applyLink: 'https://www.offcampusjobsindia.com/jobs/larsen-toubro-off-campus-software-engineer-jobs-freshers-india'
      },
      {
        id: 'JOB_SCRAPE_008', company: 'EY', companyLogo: 'E', role: 'Testing-WAM-Off Campus',
        type: 'Job', domain: 'Tech', location: 'Chennai, Tamil Nadu', mode: 'On-site',
        stipend: 'Best in Industry', skills: ['Software Testing', 'QA', 'Manual Testing', 'Automation Testing', 'SQL'], experience: 'Fresher (2024-2028 batch)',
        description: 'This is an exceptional Off Campus opportunity for aspiring B.Tech graduates from the 2024, 2025, 2026, 2027, and 2028 batches to kickstart their careers with EY Global Delivery Services (GDS) in Chennai. You will play a critical role in ensuring software quality, robustness, and ultimate success in the Wealth and Asset Management sector.',
        applications: [], postedAt: '2026-07-13', deadline: '2026-08-31', status: 'Active',
        aboutCompany: 'Ernst & Young (EY) is a global leader in assurance, tax, transaction, and advisory services.',
        perks: ['EY Badges learning program', 'Health Coverage', 'Performance Bonus'],
        process: ['Aptitude + Technical Test', 'Technical Interview', 'Partner Interview'],
        applyLink: 'https://www.offcampusjobsindia.com/jobs/ey-off-campus-jobs-testing-wam-chennai-freshers'
      },
      {
        ...
        description: 'Amazon is seeking a talented Software Development Engineer I (SDE I) for the FinOps FP&A team in Bengaluru. This role is open for recent graduates from the 2024, 2025, 2026, 2027, and 2028 batches. You will design, develop, and deploy reliable software applications at scale, working with Java, Linux, and AWS.',
        applications: [], postedAt: '2026-07-13', deadline: '2026-09-15', status: 'Active',
      ...
      {
        id: 'JOB_SCRAPE_010', company: 'Rubrik', companyLogo: 'R', role: 'Software Engineer, New Grad',
        type: 'Job', domain: 'Cloud', location: 'Bengaluru, Karnataka', mode: 'On-site',
        stipend: 'Highly Competitive', skills: ['C++', 'Java', 'Python', 'Go', 'Data Security', 'Distributed Systems'], experience: 'Fresher (2024-2025 batch)',
        description: 'Rubrik is excited to announce Off Campus opportunities for bright and aspiring Software Engineer New Grads in Bengaluru. This role is perfect for freshers from the 2024 and 2025 batches eager to kickstart their career in data security and cloud data management.',
        applications: [], postedAt: '2026-07-13', deadline: '2026-08-30', status: 'Active',
        aboutCompany: 'Rubrik is a cybersecurity company offering data security and data management solutions.',
        perks: ['Equity/Stocks', 'Wellness Allowance', 'Flexible PTO', 'Learning Budgets'],
        process: ['Resume Review', 'Coding Challenge', 'Tech Interviews x3', 'HR Round'],
        applyLink: 'https://www.offcampusjobsindia.com/jobs/rubrik-off-campus-software-engineer-new-grad-bengaluru'
      },

      /* ── LIVE JOBS FROM IITJOBS.COM (Remote Jobs in India) ── */
      {
  ...
  init() {
    ...
    if (!stored) {
      ...
      try {
        ...
        // MIGRATION: Inject scraped IT jobs if not present
        if (!data.jobs || !data.jobs.some(j => j.id.startsWith('JOB_SCRAPE_'))) {
          const scrapedJobs = this._defaults.jobs.filter(j => j.id.startsWith('JOB_SCRAPE_'));
          data.jobs = [...(data.jobs || []), ...scrapedJobs];
        }
